...
Isolated projects can now be bound together using `oc adm pod-network
join-project`.
...
=======
xref:../install_config/registry/registry_known_issues.adoc#install-config-registry-known-issues[A
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
=======
xref:../dev_guide/builds/build_inputs.adoc#binary-source[Binary builds] and the
xref:../dev_guide/builds/build_inputs.adoc#dockerfile-source[Dockerfile source type] for
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
