...
a container image registry] for more information.
=======
...
[[ose-3-2-1-34-20]]
=== RHSA-2018:3742 - OpenShift Enterprise 3.2.1.34 security and bug fix update

Issued: 2018-12-04

{product-title} release 3.2.1.34 is now available. The list of packages,
container images, and bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHSA-2018:3742[RHSA-2018:3742] advisory.
The list of container images included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2018:3741[RHBA-2018:3741] advisory.

[[ose-3-2-1-34-20-upgrading]]
==== Upgrading
