...
pipelines that create deployable container images and automatic redeployment and
...
{product-title} release 3.6.173 is now available. The packages and bug fixes
...
[[ocp-3-6-173-0-129]]
=== RHBA-2018:2545 - {product-title} 3.6.173.0.129 Bug Fix Update

Issued: 2018-08-28

{product-title} release 3.6.173.0.129 is now available. The list of packages and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2018:2545[RHBA-2018:2545] advisory.
The list of container images included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2018:2544[RHBA-2018:2544] advisory.

[[ocp-3-6-173-0-129-upgrading]]
==== Upgrading
...
[[ocp-3-6-173-0-130]]
=== RHSA-2018:2654 - {product-title} 3.6.173.0.130  Security, Bug Fix, and Enhancement Update

Issued: 2018-09-26

{product-title} release 3.6.173.0.130 is now available. The list of packages and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHSA-2018:2654[RHSA-2018:2654] advisory.
The list of container images included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2018:2655[RHBA-2018:2655] advisory.

[[ocp-3-6-173-0-130-bug-fixes]]
==== Bug Fixes

* This update adds retries to the `shared-resource-viewer` update logic to
avoid problems with object contention.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1507119[*BZ#1507119*])

[[ocp-3-6-173-0-130-upgrading]]
==== Upgrading
...
[[ocp-3-6-rhsa-2018-3598]]
=== RHSA-2018:3598 - Critical: {product-title} 3.6 Security Update

Issued: 2018-12-03

A {product-title} 3.6 security update is now available. The list of packages and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHSA-2018:3598[RHSA-2018:3598] advisory.

[[ocp-3-6-rhsa-2018-3598-upgrading]]
==== Upgrading
...
[[ocp-3-6-173-0-146]]
=== RHBA-2019:0101 - {product-title} 3.6.173.0.146 Bug Fix Update

Issued: 2019-01-31

{product-title} release 3.6.173.0.146 is now available. The list of packages and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:0101[RHBA-2019:0101] advisory.
The list of container images included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:0102[RHBA-2019:0102] advisory.

[[ocp-3-6-173-0-146-upgrading]]
==== Upgrading
...
[[ocp-3-6-173-0-155]]
=== RHBA-2019:0614 - {product-title} 3.6.173.0.155 Bug Fix Update

Issued: 2019-04-09

{product-title} release 3.6.173.0.155 is now available. The list of packages and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:0614[RHBA-2019:0614] advisory.
The list of container images included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:0615[RHBA-2019:0615] advisory.

[[ocp-3-6-173-0-155-upgrading]]
==== Upgrading
