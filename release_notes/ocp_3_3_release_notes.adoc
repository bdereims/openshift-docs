...
=======
command-line tools (`oc`, `oc adm`, and others) in macOS Sierra (10.12) get a
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
=======
The `oc adm` symlink incorrectly pointing to `oc` rather than the `openshift`
binary on containerized master hosts. This caused upgrades to fail, complaining
about missing `oc adm` functionality. This bug fix transitions to using `oc adm`
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
=======
node service and the master services that had not been restarted yet, causing the
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
