...
[[Get-apis-quota.openshift.io-v1-namespaces-namespace-appliedclusterresourcequotas-name]]
...
[[Get-apis-quota.openshift.io-v1-namespaces-namespace-appliedclusterresourcequotas]]
