...
</div></details><details><summary><span title="(v1beta1.RoleRef) RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.">roleRef</span>:
</summary><div style="margin-left:13px;">  <span title="(string) APIGroup is the group for the resource being referenced">apiGroup</span>:
</div><div style="margin-left:13px;">  <span title="(string) Kind is the type of resource being referenced">kind</span>:
</div><div style="margin-left:13px;">  <span title="(string) Name is the name of resource being referenced">name</span>:
</div></details><details><summary><span title="(array) Subjects holds references to the objects the role applies to.">subjects</span>:
</summary><div style="margin-left:13px;">- <span title="(string) APIGroup holds the API group of the referenced subject. Defaults to &#34;&#34; for ServiceAccount subjects. Defaults to &#34;rbac.authorization.k8s.io&#34; for User and Group subjects.">apiGroup</span>:
</div><div style="margin-left:13px;">  <span title="(string) Kind of object being referenced. Values defined by this API group are &#34;User&#34;, &#34;Group&#34;, and &#34;ServiceAccount&#34;. If the Authorizer does not recognized the kind value, the Authorizer should report an error.">kind</span>:
</div><div style="margin-left:13px;">  <span title="(string) Name of the object being referenced.">name</span>:
</div><div style="margin-left:13px;">  <span title="(string) Namespace of the referenced object.  If the object kind is non-namespace, such as &#34;User&#34; or &#34;Group&#34;, and this value is not empty the Authorizer should report an error.">namespace</span>:
</div></details>
</pre>
++++
...
[[Post-apis-rbac.authorization.k8s.io-v1beta1-rolebindings]]
=== Create a RoleBinding
Create a RoleBinding

==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1beta1/rolebindings HTTP/1.1
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.RoleBinding
<<<<<<< HEAD
|201 Created|v1beta1.RoleBinding
|202 Accepted|v1beta1.RoleBinding
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings <<'EOF'
{
  "kind": "RoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1beta1",
  ...
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/rolebindings
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.RoleBindingList
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings
----
...
=== Watch a RoleBinding in a namespace
Watch changes to an object of kind RoleBinding

==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/rolebindings/$NAME
----
...
=== Watch all RoleBindings
Watch individual changes to a list of RoleBinding

==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/watch/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/watch/rolebindings
----
...
=== Watch all RoleBindings in a namespace
Watch individual changes to a list of RoleBinding

==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/rolebindings
----
...
==== HTTP request
----
PUT /apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings/$NAME <<'EOF'
{
  "kind": "RoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1beta1/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
