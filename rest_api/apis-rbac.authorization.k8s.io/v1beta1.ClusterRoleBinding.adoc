...
</div></details><details><summary><span title="(v1beta1.RoleRef) RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.">roleRef</span>:
...
==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings <<'EOF'
{
  "kind": "ClusterRoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1beta1",
  ...
...
|===
|Parameter|Schema
|body|v1beta1.ClusterRoleBinding
|===
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.ClusterRoleBinding
<<<<<<< HEAD
|201 Created|v1beta1.ClusterRoleBinding
|202 Accepted|v1beta1.ClusterRoleBinding
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.ClusterRoleBindingList
|401 Unauthorized|
|===
...
=== Watch a ClusterRoleBinding
Watch changes to an object of kind ClusterRoleBinding

==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/watch/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/watch/clusterrolebindings/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1beta1/watch/clusterrolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/watch/clusterrolebindings
----
...
==== HTTP request
----
PUT /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/$NAME <<'EOF'
{
  "kind": "ClusterRoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
