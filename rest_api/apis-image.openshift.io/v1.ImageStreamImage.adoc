...
[[Get-apis-image.openshift.io-v1-namespaces-namespace-imagestreamimages-name]]
=== Get a ImageStreamImage in a namespace
Read the specified ImageStreamImage

==== HTTP request
----
GET /apis/image.openshift.io/v1/namespaces/$NAMESPACE/imagestreamimages/$NAME HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/image.openshift.io/v1/namespaces/$NAMESPACE/imagestreamimages/$NAME
----
