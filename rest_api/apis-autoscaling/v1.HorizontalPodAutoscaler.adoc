...
</div></details><details open><summary><span title="(v1.HorizontalPodAutoscalerSpec) behaviour of autoscaler. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.">spec</span>:
</summary><div style="margin-left:13px;">  <span title="(integer) upper limit for the number of pods that can be set by the autoscaler; cannot be smaller than MinReplicas.">maxReplicas</span>:
</div><div style="margin-left:13px;">  <span title="(integer) lower limit for the number of pods that can be set by the autoscaler, default 1.">minReplicas</span>:
</div><details><summary>  <span title="(v1.CrossVersionObjectReference) reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.">scaleTargetRef</span>:
</summary><div style="margin-left:13px;">    <span title="(string) API version of the referent">apiVersion</span>:
</div><div style="margin-left:13px;">    <span title="(string) Kind of the referent; More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds&#34;">kind</span>:
</div><div style="margin-left:13px;">    <span title="(string) Name of the referent; More info: http://kubernetes.io/docs/user-guide/identifiers#names">name</span>:
</div></details><div style="margin-left:13px;">  <span title="(integer) target average CPU utilization (represented as a percentage of requested CPU) over all the pods; if not specified the default autoscaling policy will be used.">targetCPUUtilizationPercentage</span>:
</div></details><details><summary><span title="(v1.HorizontalPodAutoscalerStatus) current information about the autoscaler.">status</span>:
</summary><div style="margin-left:13px;">  <span title="(integer) current average CPU utilization over all pods, represented as a percentage of requested CPU, e.g. 70 means that an average pod is using now 70% of its requested CPU.">currentCPUUtilizationPercentage</span>:
</div><div style="margin-left:13px;">  <span title="(integer) current number of replicas of pods managed by this autoscaler.">currentReplicas</span>:
</div><div style="margin-left:13px;">  <span title="(integer) desired number of replicas of pods managed by this autoscaler.">desiredReplicas</span>:
</div><div style="margin-left:13px;">  <span title="(v1.Time) last time the HorizontalPodAutoscaler scaled the number of pods; used by the autoscaler to control how often the number of pods is changed.">lastScaleTime</span>:
</div><div style="margin-left:13px;">  <span title="(integer) most recent generation observed by this autoscaler.">observedGeneration</span>:
</div></details>
</pre>
++++
...
[[Post-apis-autoscaling-v1-horizontalpodautoscalers]]
=== Create a HorizontalPodAutoscaler
Create a HorizontalPodAutoscaler

==== HTTP request
----
POST /apis/autoscaling/v1/horizontalpodautoscalers HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/autoscaling/v1/horizontalpodautoscalers <<'EOF'
{
  "kind": "HorizontalPodAutoscaler",
  "apiVersion": "autoscaling/v1",
  ...
...
|===
|Parameter|Schema
|body|v1.HorizontalPodAutoscaler
|===
...
|===
|HTTP Code|Schema
|200 OK|v1.HorizontalPodAutoscaler
<<<<<<< HEAD
|201 Created|v1.HorizontalPodAutoscaler
|202 Accepted|v1.HorizontalPodAutoscaler
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers <<'EOF'
{
  "kind": "HorizontalPodAutoscaler",
  "apiVersion": "autoscaling/v1",
  ...
...
==== HTTP request
----
GET /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME
----
...
==== HTTP request
----
GET /apis/autoscaling/v1/horizontalpodautoscalers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/horizontalpodautoscalers
----
...
|===
|HTTP Code|Schema
|200 OK|v1.HorizontalPodAutoscalerList
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers
----
...
==== HTTP request
----
GET /apis/autoscaling/v1/watch/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/watch/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME
----
...
==== HTTP request
----
GET /apis/autoscaling/v1/watch/horizontalpodautoscalers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/watch/horizontalpodautoscalers
----
...
==== HTTP request
----
GET /apis/autoscaling/v1/watch/namespaces/$NAMESPACE/horizontalpodautoscalers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/watch/namespaces/$NAMESPACE/horizontalpodautoscalers
----
...
==== HTTP request
----
PUT /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME <<'EOF'
{
  "kind": "HorizontalPodAutoscaler",
  "apiVersion": "autoscaling/v1",
  ...
...
==== HTTP request
----
PATCH /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME/status
----
...
==== HTTP request
----
PUT /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME/status <<'EOF'
{
  "kind": "HorizontalPodAutoscaler",
  "apiVersion": "autoscaling/v1",
  ...
...
==== HTTP request
----
PATCH /apis/autoscaling/v1/namespaces/$NAMESPACE/horizontalpodautoscalers/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
