...
</div></details><details open><summary><span title="(v1beta1.StatefulSetSpec) Spec defines the desired identities of pods in this set.">spec</span>:
...
</div><details><summary>  <span title="(v1.LabelSelector) selector is a label query over pods that should match the replica count. If empty, defaulted to labels on the pod template. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors">selector</span>:
...
</div></details></details></details></details><details><summary>  <span title="(v1beta1.StatefulSetUpdateStrategy) updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.">updateStrategy</span>:
</summary><details><summary>    <span title="(v1beta1.RollingUpdateStatefulSetStrategy) RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType.">rollingUpdate</span>:
</summary><div style="margin-left:13px;">      <span title="(integer) Partition indicates the ordinal at which the StatefulSet should be partitioned.">partition</span>:
</div></details><div style="margin-left:13px;">    <span title="(string) Type indicates the type of the StatefulSetUpdateStrategy.">type</span>:
...
</div></details></details></details><details><summary><span title="(v1beta1.StatefulSetStatus) Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.">status</span>:
...
</summary><div style="margin-left:13px;">  <span title="(integer) currentReplicas is the number of Pods created by the StatefulSet controller from the StatefulSet version indicated by currentRevision.">currentReplicas</span>:
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
[[Post-apis-apps-v1beta1-statefulsets]]
=== Create a StatefulSet
Create a StatefulSet

==== HTTP request
----
POST /apis/apps/v1beta1/statefulsets HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1beta1/statefulsets <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1beta1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.StatefulSet
<<<<<<< HEAD
|201 Created|v1beta1.StatefulSet
|202 Accepted|v1beta1.StatefulSet
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1beta1",
  ...
...
==== HTTP request
----
GET /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta1/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/statefulsets
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.StatefulSetList
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets
----
...
==== HTTP request
----
GET /apis/apps/v1beta1/watch/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/watch/namespaces/$NAMESPACE/statefulsets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta1/watch/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/watch/statefulsets
----
...
==== HTTP request
----
GET /apis/apps/v1beta1/watch/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/watch/namespaces/$NAMESPACE/statefulsets
----
...
==== HTTP request
----
PUT /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/scale
----
...
==== HTTP request
----
PUT /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/scale <<'EOF'
{
  "kind": "Scale",
  "apiVersion": "apps/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
...
==== HTTP request
----
GET /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/status
----
...
==== HTTP request
----
PUT /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/status <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta1/namespaces/$NAMESPACE/statefulsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
