...
</div></details><details open><summary><span title="(v1.NetworkPolicySpec) Specification of the desired behavior for this NetworkPolicy.">spec</span>:
<<<<<<< HEAD
...
</summary><div style="margin-left:13px;">  - - <span title="(intstr.IntOrString) The port on the given protocol. This can either be a numerical or named port on a pod. If this field is not provided, this matches all port names and numbers.">port</span>:
</div><div style="margin-left:13px;">      <span title="(string) The protocol (TCP or UDP) which traffic must match. If not specified, this field defaults to TCP.">protocol</span>:
...
</summary><details><summary>    - <span title="(v1.IPBlock) IPBlock defines policy on a particular IPBlock">ipBlock</span>:
...
[[Post-apis-networking.k8s.io-v1-networkpolicies]]
=== Create a NetworkPolicy
Create a NetworkPolicy

==== HTTP request
----
POST /apis/networking.k8s.io/v1/networkpolicies HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/networking.k8s.io/v1/networkpolicies <<'EOF'
{
  "kind": "NetworkPolicy",
  "apiVersion": "networking.k8s.io/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.NetworkPolicy
<<<<<<< HEAD
|201 Created|v1.NetworkPolicy
|202 Accepted|v1.NetworkPolicy
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies <<'EOF'
{
  "kind": "NetworkPolicy",
  "apiVersion": "networking.k8s.io/v1",
  ...
...
==== HTTP request
----
GET /apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies/$NAME
----
...
==== HTTP request
----
GET /apis/networking.k8s.io/v1/networkpolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/networkpolicies
----
...
==== HTTP request
----
GET /apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies
----
...
==== HTTP request
----
GET /apis/networking.k8s.io/v1/watch/namespaces/$NAMESPACE/networkpolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/watch/namespaces/$NAMESPACE/networkpolicies/$NAME
----
...
==== HTTP request
----
GET /apis/networking.k8s.io/v1/watch/networkpolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/watch/networkpolicies
----
...
==== HTTP request
----
GET /apis/networking.k8s.io/v1/watch/namespaces/$NAMESPACE/networkpolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/watch/namespaces/$NAMESPACE/networkpolicies
----
...
==== HTTP request
----
PUT /apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies/$NAME <<'EOF'
{
  "kind": "NetworkPolicy",
  "apiVersion": "networking.k8s.io/v1",
  ...
...
==== HTTP request
----
PATCH /apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/networking.k8s.io/v1/namespaces/$NAMESPACE/networkpolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
