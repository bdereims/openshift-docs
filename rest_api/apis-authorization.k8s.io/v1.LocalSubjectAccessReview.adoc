...
</div></details><details open><summary><span title="(v1.SubjectAccessReviewSpec) Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.">spec</span>:
...
</div></details><details><summary>  <span title="(array) Groups is the groups you&#39;re testing for.">groups</span>:
</summary><div style="margin-left:13px;">  - <span title="(string)">[string]</span>:
</div></details><details><summary>  <span title="(v1.NonResourceAttributes) NonResourceAttributes describes information for a non-resource access request">nonResourceAttributes</span>:
...
</div></details><details><summary>  <span title="(v1.ResourceAttributes) ResourceAuthorizationAttributes describes information for a resource access request">resourceAttributes</span>:
...
</div><div style="margin-left:13px;">  <span title="(string) User is the user you&#39;re testing for. If you specify &#34;User&#34; but not &#34;Groups&#34;, then is it interpreted as &#34;What if User were not a member of any groups">user</span>:
</div></details><details><summary><span title="(v1.SubjectAccessReviewStatus) Status is filled in by the server and indicates whether the request is allowed or not">status</span>:
...
=======
</div></details><div style="margin-left:13px;">  <span title="(string) User is the user you&#39;re testing for. If you specify &#34;User&#34; but not &#34;Groups&#34;, then is it interpreted as &#34;What if User were not a member of any groups">user</span>:
</div></details><details><summary><span title="(v1.SubjectAccessReviewStatus) Status is filled in by the server and indicates whether the request is allowed or not">status</span>:
</summary><div style="margin-left:13px;">  <span title="(boolean) Allowed is required.  True if the action would be allowed, false otherwise.">allowed</span>:
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
[[Post-apis-authorization.k8s.io-v1-localsubjectaccessreviews]]
