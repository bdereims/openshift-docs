...
</div></details><details open><summary><span title="(v1beta1.SubjectAccessReviewSpec) Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.">spec</span>:
</summary><details><summary>  <span title="(object) Extra corresponds to the user.Info.GetExtra() method from the authenticator.  Since that is input to the authorizer it needs a reflection here.">extra</span>:
</summary><div style="margin-left:13px;">    <span title="(string)">[string]</span>:
</div></details><details><summary>  <span title="(array) Groups is the groups you&#39;re testing for.">group</span>:
</summary><div style="margin-left:13px;">  - <span title="(string)">[string]</span>:
</div></details><details><summary>  <span title="(v1beta1.NonResourceAttributes) NonResourceAttributes describes information for a non-resource access request">nonResourceAttributes</span>:
...
<<<<<<< HEAD
</div></details><div style="margin-left:13px;">  <span title="(string) UID information about the requesting user.">uid</span>:
</div><div style="margin-left:13px;">  <span title="(string) User is the user you&#39;re testing for. If you specify &#34;User&#34; but not &#34;Group&#34;, then is it interpreted as &#34;What if User were not a member of any groups">user</span>:
</div></details><details><summary><span title="(v1beta1.SubjectAccessReviewStatus) Status is filled in by the server and indicates whether the request is allowed or not">status</span>:
...
=======
</div></details><div style="margin-left:13px;">  <span title="(string) User is the user you&#39;re testing for. If you specify &#34;User&#34; but not &#34;Group&#34;, then is it interpreted as &#34;What if User were not a member of any groups">user</span>:
</div></details><details><summary><span title="(v1beta1.SubjectAccessReviewStatus) Status is filled in by the server and indicates whether the request is allowed or not">status</span>:
</summary><div style="margin-left:13px;">  <span title="(boolean) Allowed is required.  True if the action would be allowed, false otherwise.">allowed</span>:
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
[[Post-apis-authorization.k8s.io-v1beta1-localsubjectaccessreviews]]
...
|===
|Parameter|Schema
|body|v1beta1.LocalSubjectAccessReview
|===
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.LocalSubjectAccessReview
<<<<<<< HEAD
|201 Created|v1beta1.LocalSubjectAccessReview
|202 Accepted|v1beta1.LocalSubjectAccessReview
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
