...
</div><details><summary><span title="(array) List of component conditions observed">conditions</span>:
</summary><div style="margin-left:13px;">- <span title="(string) Condition error code for a component. For example, a health check error code.">error</span>:
</div><div style="margin-left:13px;">  <span title="(string) Message about the condition for a component. For example, information about a health check.">message</span>:
</div><div style="margin-left:13px;">  <span title="(string) Status of the condition for a component. Valid values for &#34;Healthy&#34;: &#34;True&#34;, &#34;False&#34;, or &#34;Unknown&#34;.">status</span>:
</div><div style="margin-left:13px;">  <span title="(string) Type of condition for a component. Valid value: &#34;Healthy&#34;">type</span>:
...
==== HTTP request
----
GET /api/v1/componentstatuses/$NAME HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/api/v1/componentstatuses/$NAME
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/componentstatuses
----
