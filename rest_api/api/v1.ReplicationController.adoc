...
</div><details open><summary><span title="(v1.ObjectMeta) If the Labels of a ReplicationController are empty, they are defaulted to be the same as the Pod(s) that the replication controller manages. Standard object&#39;s metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata">metadata</span>:
...
</div></details><details open><summary><span title="(v1.ReplicationControllerSpec) Spec defines the specification of the desired behavior of the replication controller. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
...
</div><details><summary>  <span title="(object) Selector is a label query over pods that should match the Replicas count. If Selector is empty, it is defaulted to the labels present on the Pod template. Label keys and values that must match in order to be controlled by this replication controller, if empty defaulted to labels on Pod template. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors">selector</span>:
</summary><div style="margin-left:13px;">    <span title="(string)">[string]</span>:
</div></details><details><summary>  <span title="(v1.PodTemplateSpec) Template is the object that describes the pod that will be created if insufficient replicas are detected. This takes precedence over a TemplateRef. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template">template</span>:
...
</div></details></details></details></details></details><details><summary><span title="(v1.ReplicationControllerStatus) Status is the most recently observed status of the replication controller. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">status</span>:
</summary><div style="margin-left:13px;">  <span title="(integer) The number of available replicas (ready for at least minReadySeconds) for this replication controller.">availableReplicas</span>:
</div><details><summary>  <span title="(array) Represents the latest available observations of a replication controller&#39;s current state.">conditions</span>:
...
</div><div style="margin-left:13px;">    <span title="(string) Type of replication controller condition.">type</span>:
</div></details><div style="margin-left:13px;">  <span title="(integer) The number of pods that have labels matching the labels of the pod template of the replication controller.">fullyLabeledReplicas</span>:
</div><div style="margin-left:13px;">  <span title="(integer) ObservedGeneration reflects the generation of the most recently observed replication controller.">observedGeneration</span>:
</div><div style="margin-left:13px;">  <span title="(integer) The number of ready replicas for this replication controller.">readyReplicas</span>:
...
==== HTTP request
----
POST /api/v1/replicationcontrollers HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/api/v1/replicationcontrollers <<'EOF'
{
  "kind": "ReplicationController",
  "apiVersion": "v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.ReplicationController
<<<<<<< HEAD
|201 Created|v1.ReplicationController
|202 Accepted|v1.ReplicationController
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /api/v1/namespaces/$NAMESPACE/replicationcontrollers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers <<'EOF'
{
  "kind": "ReplicationController",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME
----
...
==== HTTP request
----
GET /api/v1/replicationcontrollers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/replicationcontrollers
----
...
|===
|HTTP Code|Schema
|200 OK|v1.ReplicationControllerList
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /api/v1/namespaces/$NAMESPACE/replicationcontrollers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers
----
...
==== HTTP request
----
GET /api/v1/watch/namespaces/$NAMESPACE/replicationcontrollers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/watch/namespaces/$NAMESPACE/replicationcontrollers/$NAME
----
...
==== HTTP request
----
GET /api/v1/watch/replicationcontrollers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/watch/replicationcontrollers
----
...
==== HTTP request
----
GET /api/v1/watch/namespaces/$NAMESPACE/replicationcontrollers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/watch/namespaces/$NAMESPACE/replicationcontrollers
----
...
==== HTTP request
----
PUT /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME <<'EOF'
{
  "kind": "ReplicationController",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /api/v1/namespaces/$NAMESPACE/replicationcontrollers HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale
----
...
==== HTTP request
----
GET /apis/extensions/v1beta1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/extensions/v1beta1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale
----
...
==== HTTP request
----
PUT /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale <<'EOF'
{
  "kind": "Scale",
  "apiVersion": "autoscaling/v1",
  ...
...
==== HTTP request
----
PUT /apis/extensions/v1beta1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
PATCH /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
...
==== HTTP request
----
PATCH /apis/extensions/v1beta1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
...
==== HTTP request
----
GET /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/status
----
...
==== HTTP request
----
PUT /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/status <<'EOF'
{
  "kind": "ReplicationController",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /api/v1/namespaces/$NAMESPACE/replicationcontrollers/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
