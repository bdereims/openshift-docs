...
</div><details open><summary><span title="(v1.PodSecurityPolicyReviewSpec) spec is the PodSecurityPolicy to check.">spec</span>:
</summary><details><summary>  <span title="(array) serviceAccountNames is an optional set of ServiceAccounts to run the check with. If serviceAccountNames is empty, the template.spec.serviceAccountName is used, unless it&#39;s empty, in which case &#34;default&#34; is used instead. If serviceAccountNames is specified, template.spec.serviceAccountName is ignored.">serviceAccountNames</span>:
</summary><div style="margin-left:13px;">  - <span title="(string)">[string]</span>:
</div></details><details><summary>  <span title="(v1.PodTemplateSpec) template is the PodTemplateSpec to check. The template.spec.serviceAccountName field is used if serviceAccountNames is empty, unless the template.spec.serviceAccountName is empty, in which case &#34;default&#34; is used. If serviceAccountNames is specified, template.spec.serviceAccountName is ignored.">template</span>:
...
</div></details></details></details></details></details><details><summary><span title="(v1.PodSecurityPolicyReviewStatus) status represents the current information/status for the PodSecurityPolicyReview.">status</span>:
</summary><details><summary>  <span title="(array) allowedServiceAccounts returns the list of service accounts in *this* namespace that have the power to create the PodTemplateSpec.">allowedServiceAccounts</span>:
...
</div></details><div style="margin-left:13px;">    <span title="(string) name contains the allowed and the denied ServiceAccount name">name</span>:
</div><div style="margin-left:13px;">    <span title="(string) A machine-readable description of why this operation is in the &#34;Failure&#34; status. If this value is empty there is no information available.">reason</span>:
...
</div></details></details></details></details></details></details>
</pre>
++++

== Operations

[[Post-apis-security.openshift.io-v1-podsecuritypolicyreviews]]
=== Create a PodSecurityPolicyReview
Create a PodSecurityPolicyReview

==== HTTP request
----
POST /apis/security.openshift.io/v1/podsecuritypolicyreviews HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/security.openshift.io/v1/podsecuritypolicyreviews <<'EOF'
{
  "kind": "PodSecurityPolicyReview",
  "apiVersion": "security.openshift.io/v1",
  ...
...
<<<<<<< HEAD
|201 Created|v1.PodSecurityPolicyReview
|202 Accepted|v1.PodSecurityPolicyReview
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
[[Post-apis-security.openshift.io-v1-namespaces-namespace-podsecuritypolicyreviews]]
=== Create a PodSecurityPolicyReview in a namespace
Create a PodSecurityPolicyReview

==== HTTP request
----
POST /apis/security.openshift.io/v1/namespaces/$NAMESPACE/podsecuritypolicyreviews HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/security.openshift.io/v1/namespaces/$NAMESPACE/podsecuritypolicyreviews <<'EOF'
{
  "kind": "PodSecurityPolicyReview",
  "apiVersion": "security.openshift.io/v1",
  ...
