...
[[Post-apis-security.openshift.io-v1-podsecuritypolicysubjectreviews]]
...
[[Post-apis-security.openshift.io-v1-namespaces-namespace-podsecuritypolicysubjectreviews]]
