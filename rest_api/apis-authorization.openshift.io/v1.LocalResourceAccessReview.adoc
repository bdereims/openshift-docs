...
[[Post-apis-authorization.openshift.io-v1-localresourceaccessreviews]]
=== Create a LocalResourceAccessReview
Create a LocalResourceAccessReview

==== HTTP request
----
POST /apis/authorization.openshift.io/v1/localresourceaccessreviews HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/authorization.openshift.io/v1/localresourceaccessreviews <<'EOF'
{
  "kind": "LocalResourceAccessReview",
  "apiVersion": "authorization.openshift.io/v1",
  ...
...
[[Post-apis-authorization.openshift.io-v1-namespaces-namespace-localresourceaccessreviews]]
=== Create a LocalResourceAccessReview in a namespace
Create a LocalResourceAccessReview

==== HTTP request
----
POST /apis/authorization.openshift.io/v1/namespaces/$NAMESPACE/localresourceaccessreviews HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/authorization.openshift.io/v1/namespaces/$NAMESPACE/localresourceaccessreviews <<'EOF'
{
  "kind": "LocalResourceAccessReview",
  "apiVersion": "authorization.openshift.io/v1",
  ...
