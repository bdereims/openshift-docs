...
==== HTTP request
----
POST /apis/authorization.openshift.io/v1/localsubjectaccessreviews HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/authorization.openshift.io/v1/localsubjectaccessreviews <<'EOF'
{
  "kind": "LocalSubjectAccessReview",
  "apiVersion": "authorization.openshift.io/v1",
  ...
...
[[Post-apis-authorization.openshift.io-v1-namespaces-namespace-localsubjectaccessreviews]]
=== Create a LocalSubjectAccessReview in a namespace
Create a LocalSubjectAccessReview

==== HTTP request
----
POST /apis/authorization.openshift.io/v1/namespaces/$NAMESPACE/localsubjectaccessreviews HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/authorization.openshift.io/v1/namespaces/$NAMESPACE/localsubjectaccessreviews <<'EOF'
{
  "kind": "LocalSubjectAccessReview",
  "apiVersion": "authorization.openshift.io/v1",
  ...
