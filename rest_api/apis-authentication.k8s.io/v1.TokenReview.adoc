...
</div></details><details open><summary><span title="(v1.TokenReviewSpec) Spec holds information about the request being evaluated">spec</span>:
</summary><div style="margin-left:13px;">  <span title="(string) Token is the opaque bearer token.">token</span>:
</div></details><details><summary><span title="(v1.TokenReviewStatus) Status is filled in by the server and indicates whether the request can be authenticated.">status</span>:
</summary><div style="margin-left:13px;">  <span title="(boolean) Authenticated indicates that the token was associated with a known user.">authenticated</span>:
</div><div style="margin-left:13px;">  <span title="(string) Error indicates that the token couldn&#39;t be checked">error</span>:
</div><details><summary>  <span title="(v1.UserInfo) User is the UserInfo associated with the provided token.">user</span>:
</summary><details><summary>    <span title="(object) Any additional information provided by the authenticator.">extra</span>:
</summary><div style="margin-left:13px;">      <span title="(string)">[string]</span>:
</div></details><details><summary>    <span title="(array) The names of groups this user is a part of.">groups</span>:
</summary><div style="margin-left:13px;">    - <span title="(string)">[string]</span>:
</div></details><div style="margin-left:13px;">    <span title="(string) A unique value that identifies this user across time. If this user is deleted and another user by the same name is added, they will have different UIDs.">uid</span>:
</div><div style="margin-left:13px;">    <span title="(string) The name that uniquely identifies this user among all active users.">username</span>:
</div></details></details>
</pre>
++++
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/authentication.k8s.io/v1/tokenreviews <<'EOF'
{
  "kind": "TokenReview",
  "apiVersion": "authentication.k8s.io/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.TokenReview
<<<<<<< HEAD
|201 Created|v1.TokenReview
|202 Accepted|v1.TokenReview
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
