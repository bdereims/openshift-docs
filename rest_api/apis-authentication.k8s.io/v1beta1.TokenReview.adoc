...
</div></details><details open><summary><span title="(v1beta1.TokenReviewSpec) Spec holds information about the request being evaluated">spec</span>:
</summary><div style="margin-left:13px;">  <span title="(string) Token is the opaque bearer token.">token</span>:
</div></details><details><summary><span title="(v1beta1.TokenReviewStatus) Status is filled in by the server and indicates whether the request can be authenticated.">status</span>:
...
</div><details><summary>  <span title="(v1beta1.UserInfo) User is the UserInfo associated with the provided token.">user</span>:
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.TokenReview
<<<<<<< HEAD
|201 Created|v1beta1.TokenReview
|202 Accepted|v1beta1.TokenReview
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
