...
==== HTTP request
----
POST /apis/storage.k8s.io/v1/storageclasses HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/storage.k8s.io/v1/storageclasses <<'EOF'
{
  "kind": "StorageClass",
  "apiVersion": "storage.k8s.io/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.StorageClass
<<<<<<< HEAD
|201 Created|v1.StorageClass
|202 Accepted|v1.StorageClass
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/storage.k8s.io/v1/storageclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1/storageclasses/$NAME
----
...
==== HTTP request
----
GET /apis/storage.k8s.io/v1/storageclasses HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1/storageclasses
----
...
==== HTTP request
----
GET /apis/storage.k8s.io/v1/watch/storageclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1/watch/storageclasses/$NAME
----
...
==== HTTP request
----
GET /apis/storage.k8s.io/v1/watch/storageclasses HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1/watch/storageclasses
----
...
==== HTTP request
----
PUT /apis/storage.k8s.io/v1/storageclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1/storageclasses/$NAME <<'EOF'
{
  "kind": "StorageClass",
  "apiVersion": "storage.k8s.io/v1",
  ...
...
==== HTTP request
----
PATCH /apis/storage.k8s.io/v1/storageclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/storage.k8s.io/v1/storageclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/storage.k8s.io/v1/storageclasses HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
