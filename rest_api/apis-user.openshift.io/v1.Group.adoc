...
</div></details><details><summary><span title="(array) Users is the list of users in this group.">users</span>:
</summary><div style="margin-left:13px;">- <span title="(string)">[string]</span>:
</div></details>
</pre>
++++
...
[[Post-apis-user.openshift.io-v1-groups]]
=== Create a Group
Create a Group

==== HTTP request
----
POST /apis/user.openshift.io/v1/groups HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/user.openshift.io/v1/groups <<'EOF'
{
  "kind": "Group",
  "apiVersion": "user.openshift.io/v1",
  ...
...
|200 OK|v1.Group
<<<<<<< HEAD
|201 Created|v1.Group
|202 Accepted|v1.Group
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
[[Get-apis-user.openshift.io-v1-groups-name]]
=== Get a Group
Read the specified Group

==== HTTP request
----
GET /apis/user.openshift.io/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/groups/$NAME
----
...
==== HTTP request
----
GET /apis/user.openshift.io/v1/groups HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/groups
----
...
[[Get-apis-user.openshift.io-v1-watch-groups-name]]
=== Watch a Group
Watch changes to an object of kind Group

==== HTTP request
----
GET /apis/user.openshift.io/v1/watch/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/watch/groups/$NAME
----
...
[[Get-apis-user.openshift.io-v1-watch-groups]]
=== Watch all Groups
Watch individual changes to a list of Group

==== HTTP request
----
GET /apis/user.openshift.io/v1/watch/groups HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/watch/groups
----
...
[[Put-apis-user.openshift.io-v1-groups-name]]
=== Update a Group
Replace the specified Group

==== HTTP request
----
PUT /apis/user.openshift.io/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/groups/$NAME <<'EOF'
{
  "kind": "Group",
  "apiVersion": "user.openshift.io/v1",
  ...
...
[[Patch-apis-user.openshift.io-v1-groups-name]]
=== Patch a Group
Partially update the specified Group

==== HTTP request
----
PATCH /apis/user.openshift.io/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
[[Delete-apis-user.openshift.io-v1-groups-name]]
=== Delete a Group
Delete a Group

==== HTTP request
----
DELETE /apis/user.openshift.io/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/user.openshift.io/v1/groups HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
