...
<<<<<<< HEAD
</div><details><summary>  <span title="(array) Represents the latest available observations of a DaemonSet&#39;s current state.">conditions</span>:
...
</div><div style="margin-left:13px;">    <span title="(string) Type of DaemonSet condition.">type</span>:
</div></details><div style="margin-left:13px;">  <span title="(integer) The number of nodes that are running at least 1 daemon pod and are supposed to run the daemon pod. More info: https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/">currentNumberScheduled</span>:
=======
...
<<<<<<< HEAD
|201 Created|v1beta1.DaemonSet
|202 Accepted|v1beta1.DaemonSet
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
