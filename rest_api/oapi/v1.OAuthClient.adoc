...
==== HTTP request
----
POST /oapi/v1/oauthclients HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/oauthclients <<'EOF'
{
  "kind": "OAuthClient",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /oapi/v1/oauthclients/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/oauthclients/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/oauthclients HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/oauthclients
----
...
==== HTTP request
----
GET /oapi/v1/watch/oauthclients/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/oauthclients/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/oauthclients HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/oauthclients
----
...
==== HTTP request
----
PUT /oapi/v1/oauthclients/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/oauthclients/$NAME <<'EOF'
{
  "kind": "OAuthClient",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/oauthclients/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/oauthclients/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /oapi/v1/oauthclients HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
