...
==== HTTP request
----
POST /oapi/v1/oauthaccesstokens HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/oauthaccesstokens <<'EOF'
{
  "kind": "OAuthAccessToken",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /oapi/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/oauthaccesstokens/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/oauthaccesstokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/oauthaccesstokens
----
...
==== HTTP request
----
GET /oapi/v1/watch/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/oauthaccesstokens/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/oauthaccesstokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/oauthaccesstokens
----
...
==== HTTP request
----
PUT /oapi/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/oauthaccesstokens/$NAME <<'EOF'
{
  "kind": "OAuthAccessToken",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /oapi/v1/oauthaccesstokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
