...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/roles <<'EOF'
{
  "kind": "Role",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
POST /oapi/v1/namespaces/$NAMESPACE/roles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/roles <<'EOF'
{
  "kind": "Role",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /oapi/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/roles/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/namespaces/$NAMESPACE/roles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/roles
----
...
==== HTTP request
----
PUT /oapi/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/roles/$NAME <<'EOF'
{
  "kind": "Role",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
