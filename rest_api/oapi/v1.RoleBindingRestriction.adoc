...
==== HTTP request
----
POST /oapi/v1/rolebindingrestrictions HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/rolebindingrestrictions <<'EOF'
{
  "kind": "RoleBindingRestriction",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
POST /oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions <<'EOF'
{
  "kind": "RoleBindingRestriction",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/rolebindingrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/rolebindingrestrictions
----
...
==== HTTP request
----
GET /oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions
----
...
==== HTTP request
----
GET /oapi/v1/watch/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/rolebindingrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/rolebindingrestrictions
----
...
==== HTTP request
----
GET /oapi/v1/watch/namespaces/$NAMESPACE/rolebindingrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/namespaces/$NAMESPACE/rolebindingrestrictions
----
...
==== HTTP request
----
PUT /oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME <<'EOF'
{
  "kind": "RoleBindingRestriction",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /oapi/v1/namespaces/$NAMESPACE/rolebindingrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
