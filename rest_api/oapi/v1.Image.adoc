...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/images <<'EOF'
{
  "kind": "Image",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /oapi/v1/images/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/images/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/images/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/images/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/images HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/images
----
...
==== HTTP request
----
PUT /oapi/v1/images/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/images/$NAME <<'EOF'
{
  "kind": "Image",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/images/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/images/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /oapi/v1/images HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
