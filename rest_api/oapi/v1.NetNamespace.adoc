...
==== HTTP request
----
POST /oapi/v1/netnamespaces HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/netnamespaces <<'EOF'
{
  "kind": "NetNamespace",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /oapi/v1/netnamespaces/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/netnamespaces/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/netnamespaces HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/netnamespaces
----
...
==== HTTP request
----
GET /oapi/v1/watch/netnamespaces/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/netnamespaces/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/netnamespaces HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/netnamespaces
----
...
==== HTTP request
----
PUT /oapi/v1/netnamespaces/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/netnamespaces/$NAME <<'EOF'
{
  "kind": "NetNamespace",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/netnamespaces/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/netnamespaces/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /oapi/v1/netnamespaces HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
