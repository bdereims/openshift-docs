...
</div></details><details open><summary><span title="(v1.ProjectSpec) Spec defines the behavior of the Namespace.">spec</span>:
</summary><details><summary>  <span title="(array) Finalizers is an opaque list of values that must be empty to permanently remove object from storage">finalizers</span>:
</summary><div style="margin-left:13px;">  - <span title="(string)">[string]</span>:
</div></details></details><details><summary><span title="(v1.ProjectStatus) Status describes the current status of a Namespace">status</span>:
</summary><div style="margin-left:13px;">  <span title="(string) Phase is the current lifecycle phase of the project">phase</span>:
</div></details>
</pre>
++++
...
==== HTTP request
----
POST /oapi/v1/projects HTTP/1.1
...
|200 OK|v1.Project
<<<<<<< HEAD
|201 Created|v1.Project
|202 Accepted|v1.Project
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /oapi/v1/projects/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/projects/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/projects/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/projects/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/projects HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/projects
----
...
==== HTTP request
----
PUT /oapi/v1/projects/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/projects/$NAME <<'EOF'
{
  "kind": "Project",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/projects/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/projects/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
<<<<<<< HEAD
