...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/groups <<'EOF'
{
  "kind": "Group",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
GET /oapi/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/groups/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/groups/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/groups HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/groups
----
...
==== HTTP request
----
PUT /oapi/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/groups/$NAME <<'EOF'
{
  "kind": "Group",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/groups/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /oapi/v1/groups HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
