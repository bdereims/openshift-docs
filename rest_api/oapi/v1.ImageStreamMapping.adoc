...
==== HTTP request
----
POST /oapi/v1/imagestreammappings HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/imagestreammappings <<'EOF'
{
  "kind": "ImageStreamMapping",
  "apiVersion": "v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.ImageStreamMapping
<<<<<<< HEAD
|201 Created|v1.ImageStreamMapping
|202 Accepted|v1.ImageStreamMapping
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /oapi/v1/namespaces/$NAMESPACE/imagestreammappings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/imagestreammappings <<'EOF'
{
  "kind": "ImageStreamMapping",
  "apiVersion": "v1",
  ...
