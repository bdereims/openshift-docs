...
</div><div style="margin-left:13px;"><span title="(string) CodeChallenge is the optional code_challenge associated with this authorization code, as described in rfc7636">codeChallenge</span>:
</div><div style="margin-left:13px;"><span title="(string) CodeChallengeMethod is the optional code_challenge_method associated with this authorization code, as described in rfc7636">codeChallengeMethod</span>:
...
</div></details><div style="margin-left:13px;"><span title="(string) State data from request">state</span>:
</div><div style="margin-left:13px;"><span title="(string) UserName is the user name associated with this token">userName</span>:
</div><div style="margin-left:13px;"><span title="(string) UserUID is the unique UID associated with this token. UserUID and UserName must both match for this token to be valid.">userUID</span>:
</div>
</pre>
++++
...
==== HTTP request
----
POST /oapi/v1/oauthauthorizetokens HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/oauthauthorizetokens <<'EOF'
{
  "kind": "OAuthAuthorizeToken",
  "apiVersion": "v1",
  ...
...
<<<<<<< HEAD
|201 Created|v1.OAuthAuthorizeToken
|202 Accepted|v1.OAuthAuthorizeToken
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /oapi/v1/oauthauthorizetokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/oauthauthorizetokens/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/oauthauthorizetokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/oauthauthorizetokens
----
...
==== HTTP request
----
GET /oapi/v1/watch/oauthauthorizetokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/oauthauthorizetokens/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/watch/oauthauthorizetokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/watch/oauthauthorizetokens
----
...
==== HTTP request
----
PUT /oapi/v1/oauthauthorizetokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/oauthauthorizetokens/$NAME <<'EOF'
{
  "kind": "OAuthAuthorizeToken",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/oauthauthorizetokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/oauthauthorizetokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /oapi/v1/oauthauthorizetokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
