...
==== HTTP request
----
POST /oapi/v1/clusterrolebindings HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/clusterrolebindings <<'EOF'
{
  "kind": "ClusterRoleBinding",
  "apiVersion": "v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.ClusterRoleBinding
<<<<<<< HEAD
|201 Created|v1.ClusterRoleBinding
|202 Accepted|v1.ClusterRoleBinding
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /oapi/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/clusterrolebindings/$NAME
----
...
==== HTTP request
----
GET /oapi/v1/clusterrolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/oapi/v1/clusterrolebindings
----
...
|===
|HTTP Code|Schema
|200 OK|v1.ClusterRoleBindingList
|401 Unauthorized|
|===
...
==== HTTP request
----
PUT /oapi/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/clusterrolebindings/$NAME <<'EOF'
{
  "kind": "ClusterRoleBinding",
  "apiVersion": "v1",
  ...
...
==== HTTP request
----
PATCH /oapi/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /oapi/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
