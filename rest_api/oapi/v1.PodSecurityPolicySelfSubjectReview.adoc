...
==== HTTP request
----
POST /oapi/v1/podsecuritypolicyselfsubjectreviews HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/oapi/v1/podsecuritypolicyselfsubjectreviews <<'EOF'
{
  "kind": "PodSecurityPolicySelfSubjectReview",
  "apiVersion": "v1",
  ...
...
<<<<<<< HEAD
|201 Created|v1.PodSecurityPolicySelfSubjectReview
|202 Accepted|v1.PodSecurityPolicySelfSubjectReview
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /oapi/v1/namespaces/$NAMESPACE/podsecuritypolicyselfsubjectreviews HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/oapi/v1/namespaces/$NAMESPACE/podsecuritypolicyselfsubjectreviews <<'EOF'
{
  "kind": "PodSecurityPolicySelfSubjectReview",
  "apiVersion": "v1",
  ...
