...
</div><div style="margin-left:13px;"><span title="(string) AuthorizeToken contains the token that authorized this token">authorizeToken</span>:
</div><div style="margin-left:13px;"><span title="(string) ClientName references the client that created this token.">clientName</span>:
</div><div style="margin-left:13px;"><span title="(integer) ExpiresIn is the seconds from CreationTime before this token expires.">expiresIn</span>:
<<<<<<< HEAD
</div><div style="margin-left:13px;"><span title="(integer) InactivityTimeoutSeconds is the value in seconds, from the CreationTimestamp, after which this token can no longer be used. The value is automatically incremented when the token is used.">inactivityTimeoutSeconds</span>:
=======
...
</div></details><div style="margin-left:13px;"><span title="(string) RedirectURI is the redirection associated with the token.">redirectURI</span>:
</div><div style="margin-left:13px;"><span title="(string) RefreshToken is the value by which this token can be renewed. Can be blank.">refreshToken</span>:
</div><details><summary><span title="(array) Scopes is an array of the requested scopes.">scopes</span>:
</summary><div style="margin-left:13px;">- <span title="(string)">[string]</span>:
</div></details><div style="margin-left:13px;"><span title="(string) UserName is the user name associated with this token">userName</span>:
</div><div style="margin-left:13px;"><span title="(string) UserUID is the unique UID associated with this token">userUID</span>:
</div>
</pre>
++++
...
==== HTTP request
----
POST /apis/oauth.openshift.io/v1/oauthaccesstokens HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/oauth.openshift.io/v1/oauthaccesstokens <<'EOF'
{
  "kind": "OAuthAccessToken",
  "apiVersion": "oauth.openshift.io/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.OAuthAccessToken
<<<<<<< HEAD
|201 Created|v1.OAuthAccessToken
|202 Accepted|v1.OAuthAccessToken
=======
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
|401 Unauthorized|
|===
...
[[Get-apis-oauth.openshift.io-v1-oauthaccesstokens-name]]
=== Get a OAuthAccessToken
Read the specified OAuthAccessToken

==== HTTP request
----
GET /apis/oauth.openshift.io/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/oauth.openshift.io/v1/oauthaccesstokens/$NAME
----
...
|===
|Parameter|Description
|name|name of the OAuthAccessToken
|===
...
==== HTTP request
----
GET /apis/oauth.openshift.io/v1/oauthaccesstokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/oauth.openshift.io/v1/oauthaccesstokens
----
...
|===
|HTTP Code|Schema
|200 OK|v1.OAuthAccessTokenList
|401 Unauthorized|
|===
...
[[Get-apis-oauth.openshift.io-v1-watch-oauthaccesstokens-name]]
=== Watch a OAuthAccessToken
Watch changes to an object of kind OAuthAccessToken

==== HTTP request
----
GET /apis/oauth.openshift.io/v1/watch/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/oauth.openshift.io/v1/watch/oauthaccesstokens/$NAME
----
...
[[Get-apis-oauth.openshift.io-v1-watch-oauthaccesstokens]]
=== Watch all OAuthAccessTokens
Watch individual changes to a list of OAuthAccessToken

==== HTTP request
----
GET /apis/oauth.openshift.io/v1/watch/oauthaccesstokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/oauth.openshift.io/v1/watch/oauthaccesstokens
----
...
[[Put-apis-oauth.openshift.io-v1-oauthaccesstokens-name]]
=== Update a OAuthAccessToken
Replace the specified OAuthAccessToken

==== HTTP request
----
PUT /apis/oauth.openshift.io/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/oauth.openshift.io/v1/oauthaccesstokens/$NAME <<'EOF'
{
  "kind": "OAuthAccessToken",
  "apiVersion": "oauth.openshift.io/v1",
  ...
...
[[Patch-apis-oauth.openshift.io-v1-oauthaccesstokens-name]]
=== Patch a OAuthAccessToken
Partially update the specified OAuthAccessToken

==== HTTP request
----
PATCH /apis/oauth.openshift.io/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/oauth.openshift.io/v1/oauthaccesstokens/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
=== Delete all OAuthAccessTokens
Delete collection of OAuthAccessToken

==== HTTP request
----
DELETE /apis/oauth.openshift.io/v1/oauthaccesstokens HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
