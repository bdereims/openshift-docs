...
managed by the cluster. (It is not an external image.)
...
without modifying Docker daemon settings. This is the default policy.
...
+
ifdef::openshift-origin,openshift-dedicated,openshift-online[]
...
latest: digest: sha256:be8bc4068b2f60cf274fc216e4caba6aa845fff5fa29139e6e7497bb57e48d67 size: 6273
----
endif::openshift-origin,openshift-dedicated,openshift-online[]
