...
=======
(`memcached-operator`) using tools and libraries provided by the Operator SDK,
and shows how to manage the new Operator's lifecycle from installation through
