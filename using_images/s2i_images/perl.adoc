...
The https://github.com/sclorg/s2i-perl-container[Perl S2I builder image]
...
https://github.com/sclorg/s2i-perl-container/tree/master/5.16[5.16],
https://github.com/sclorg/s2i-perl-container/tree/master/5.20[5.20], and
https://github.com/sclorg/s2i-perl-container/tree/master/5.24[5.24] of Perl.
...
link:https://github.com/sclorg/dancer-ex[sample Dancer application].
