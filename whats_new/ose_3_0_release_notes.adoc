...
=======
- Enabling clustering for xref:../using_images/db_images/index.adoc#using-images-db-images-index[database
images].
...
3.0. For the release notes for OpenShift Enterprise 3.0, refer
...
release of JBoss EAP. To learn about these differences, read
...
learn about these differences, read
...
=======
the `oc adm reconcile-cluster-roles` command has been added to
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
container image registry API (e.g., Pulp read-only registries).
...
=======
of users are now supported. Cluster administrators can use the `oc adm groups`
>>>>>>> 6bcfc60496ce2d67bb2988b30404317813a382f5
...
to work properly.
* A xref:../architecture/core_concepts/routes.adoc#f5-router[new *F5 BIG-IP®*
...
* Upgraded the internal container image registry to v2.0.1.
