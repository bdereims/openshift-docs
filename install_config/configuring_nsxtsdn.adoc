...
Lastly, check NSX configuration updates after deployement: +
Check routing:
image:images/nsxt-routing.png[NSX routing]

Observe Network Traceflow and visibility, for example between 'console' and 'grafana'. A precious help to understand, secure and optimize communications between pods: +
